...
IVR_MESSAGE = "Welcome to the Plivo IVR Demo App. Press 1 to hear a random joke. Press 2 to listen to a song."
...
def ivr():
    ...
    if request.method == 'GET':
        ...
        getDigits = plivoxml.GetDigits(action=getdigits_action_url, method='POST',
        timeout=7, numDigits=1, retries=1)
