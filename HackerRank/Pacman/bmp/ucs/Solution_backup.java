...
class OrderedPointSet {
    private SortedSet<lifonode> points;
  public OrderedPointSet(){
        points = new TreeSet<lifonode>(new Comparator<lifonode>(){
            public int compare(lifonode p1, lifonode p2) {
